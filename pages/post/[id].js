...
class PostPage extends React.Component {
	render() {
		const OGimage = this.props.posts[0].data.image
		...
		return (
			<Page>
				<Head>
					...
					<meta
						property="og:title"
						content={`${this.props.posts[0].data.title} – DotWatcher.cc`}
					/>
					<meta
				...
				<PostWrapper fl w_100 w_50_l pa4>
					...
					>
						<A near_black f6 href="#">
							« Back to {this.props.posts[0].data.categories.fields.title} feed
						</A>
					</Link>
					<Post
						key={this.props.posts[0].sys.id}
						id={this.props.posts[0].sys.id}
						data={this.props.posts[0].data}
					/>
					<P measure lh_copy f6 silver>
						If you would like to get in touch email us at{" "}
						<A link gray underline hover_blue href="mailto:info@dotwatcher.cc">
							info@dotwatcher.cc
						</A>
					</P>
					<P measure f6 silver>
